        ...
        <div className="container mx-auto px-4 py-6 md:py-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-2 max-w-xl text-xs text-muted-foreground md:text-sm">
              Commit SOL before launch and receive tokens proportional to your contribution at launch, plus an ongoing creator-fee share on select tokens.
            </p>
                ...
                {paginatedLaunches.map((launch, i) => {
                  ...
                  return (
                    <LaunchCard
                      ...
                      codevEnabled={(launch as any).codev_sharing_enabled}
