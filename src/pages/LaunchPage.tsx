...
import CodevBadge from "@/components/launch/CodevBadge";
          ...
          <div className="sticky top-20 space-y-4">
            ...
            <div className="border border-primary/30 bg-card p-6 space-y-5">
              <div className="flex items-center justify-between">
                ...
                <CodevBadge enabled={(launch as any).codev_sharing_enabled} size="sm" />
              </div>
              ...
              <div className="rounded-sm border border-border bg-background p-3 space-y-2">
                ...
                {isPumpfun ? (
                  <div className="space-y-1">
                    ...
                    {(launch as any).codev_sharing_enabled && (
                      <div className="flex items-center gap-2 text-xs text-muted-foreground">
                        <div className="h-1.5 w-1.5 rounded-full bg-success" />
                        Eligible to earn an ongoing creator-fee share as a co-dev (seats may be limited)
                      </div>
                    )}
                  </div>
                ) : (
