...
const modeLabel = (mode: string) =>
  mode === "fcfs" ? "Top 100 by size" : "First 100";
  ...
  return (
    <div className="border border-border bg-card p-4">
      ...
      <p className="mt-3 text-[10px] leading-relaxed text-muted-foreground">
        ...
        {info.mode === "fcfs"
          ? " Only the 100 largest contributors become co-devs, decided once the token launches."
          : " The first 100 contributors become co-devs."}
      </p>
